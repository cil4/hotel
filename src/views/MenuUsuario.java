...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		contentPane.setBackground(new Color(241,241,208));
		...
		panelMenu.setBackground(new Color(42,65,104));
		...
		btnRegistro.setBackground(new Color(42,65,104));
		...
		btnBuscar.setBackground(new Color(42,65,104));
		...
		btnexit.setBackground(new Color(241,241,208));
	    ...
	    panelFecha.setBackground(new Color(93,119,151));
	    panelFecha.setBounds(256, 84, 688, 121);
	    contentPane.add(panelFecha);
	    panelFecha.setLayout(null);
	    
	    JLabel lblTitulo = new JLabel("SISTEMAS DE RESERVAS HOTEL ALURA");
	    lblTitulo.setBounds(60, 11, 586, 42);
	    panelFecha.add(lblTitulo);
	    lblTitulo.setForeground(Color.WHITE);
	    lblTitulo.setFont(new Font("Roboto", Font.PLAIN, 28));
	    
	    JLabel labelFecha = new JLabel("New label");
	    labelFecha.setBounds(50, 64, 294, 36);
	    panelFecha.add(labelFecha);
	    labelFecha.setForeground(Color.WHITE);
	    labelFecha.setFont(new Font("Roboto", Font.PLAIN, 19));
	    ...
	    labelFecha.setText("Día de la fecha: " + fecha); //setear la representacion en cadena de la fecha
	    
	    JLabel lblBienvenido = new JLabel("Bienvenido usuario");
	    lblBienvenido.setFont(new Font("Roboto", Font.BOLD, 24));
	    lblBienvenido.setBounds(302, 234, 250, 46);
	    lblBienvenido.setForeground(new Color(68,68,68));
	    ...
	    labelDescripcion.setForeground(new Color(68,68,68));
	    ...
	    labelDescripcion_1.setForeground(new Color(68,68,68));
	    ...
	    lblDescripcion_3.setBounds(302, 444, 295, 27);
	    lblDescripcion_3.setForeground(new Color(68,68,68));
	    ...
	    lblDescripcion_4.setBounds(302, 482, 355, 27);
	    lblDescripcion_4.setForeground(new Color(68,68,68));
	    ...
	    lblDescripcion_5.setBounds(302, 520, 295, 27);
	    lblDescripcion_5.setForeground(new Color(68,68,68));
