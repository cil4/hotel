...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		imagenFondo.setIcon(new ImageIcon(MenuPrincipal.class.getResource("/imagenes/recepcion.jpg")));
		...
		panel_1.setBackground(new Color(127,57,56));
		panel.add(panel_1);
		panel_1.setLayout(null);
		
		JLabel lblCopyR = new JLabel("Desarrollado por Marianela C. Gamarra © 2023");
		lblCopyR.setBounds(245, 11, 350, 19);
		lblCopyR.setForeground(new Color(254,255,254));
		...
		lblTitulo.setForeground(new Color(42,65,104));
