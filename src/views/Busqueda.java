...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		lblTitulo.setBounds(331, 62, 300, 42);
		lblTitulo.setForeground(new Color(68,68,68));
		lblTitulo.setFont(new Font("Roboto Black", Font.BOLD, 24));
		contentPane.add(lblTitulo);
		
		JTabbedPane panel = new JTabbedPane(JTabbedPane.TOP);
		panel.setBounds(20, 169, 865, 328);
		panel.setBackground(new Color(93,119,151));
		...
		btnAtras.setBackground(new Color(241,241,208));
		...
		btnEditar.setBackground(new Color(42,65,104));
		...
		btnEliminar.setBackground(new Color(127,57,56));
	...
	private void LlenarTablaHuespedes() {			       
		...
		try {
			for (Huespedes huespedes : huesped) {
				modeloHuesped.addRow(new Object[] { huespedes.getId(), huespedes.getNombre(), huespedes.getApellido(), huespedes.getFechaNacimiento(), huespedes.getNacionalidad(), huespedes.getTelefono(), huespedes.getIdReservas() });
			}
		} catch (Exception e) {
			throw e;
		}
