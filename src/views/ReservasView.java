...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblCheckOut.setBounds(68, 221, 199, 15);
		...
		txtValor.setBackground(new Color(241,241,208));
		txtValor.setHorizontalAlignment(SwingConstants.CENTER);
		txtValor.setForeground(new Color(68,68,68));
		...
		lblValor.setBounds(72, 303, 206, 15);
		...
		txtFormaPago.setFont(new Font("Roboto", Font.PLAIN, 17));
		...
		lblTitulo.setBounds(68, 60, 309, 42);
		lblTitulo.setForeground(new Color(68,68,68));
		lblTitulo.setFont(new Font("Roboto", Font.PLAIN, 26));
		panel.add(lblTitulo);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(428, 0, 482, 560);
		panel_1.setBackground(new Color(93,119,151));
		panel.add(panel_1);
		...
		btnsiguiente.setBackground(new Color(42,65,104));
